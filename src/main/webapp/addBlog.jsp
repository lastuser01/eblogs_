            ...
            <div class="col-md-8">
                <div class="card bg-transparent">
                    <div class="card-body">
                        ...
                        <%
                        String successMsg = (String)session.getAttribute("blog_success");
                        if(successMsg != null) {
                        %>
                            <div class="alert alert-success" role="alert"><%= successMsg %></div>
                        <%
                        session.removeAttribute("blog_success");
                        }

                        String errorMsg = (String)session.getAttribute("blog_error");
                        if(errorMsg != null) {
                        %>
                        ...
                        <form action="AddBlogServlet" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-light">Enter a URL for your blog image</small>
                            </div>

                            <div class="text-center">
                                <button type="submit" class="btn btn-lg text-light">Publish Blog</button>
                            </div>
                        </form>
                    </div>
                </div>
