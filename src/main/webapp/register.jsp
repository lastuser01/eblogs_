		...
		<div class="row d-flex justify-content-center align-items-center mt-5">
			<div id="d1" class="col-md-6">
				...
				<div class="card mt-2">
					...
					<% 
					String failedMsg = (String)session.getAttribute("reg_failed");
					if(failedMsg != null) {
					%>
						<div class="alert alert-danger" role="alert"><%= failedMsg %></div>
					<%
					session.removeAttribute("reg_failed");
					}
					%>	
						...
						<div class="col">
							...
							<div class="mb-3">
								<input type="text"
									...
									aria-describedby="usernameHelp" name="uname"
							...
							<button type="submit" class="btn mb-3 col-12 text-light">Register</button>

							<div align="center" class="text-light" style="border: none;">
								Already have an account? <a href="login.jsp" id="login" class="text-light">Login Now</a>
							</div>
						</div>
					</div>
					</form>
