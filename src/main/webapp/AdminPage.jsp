...
<div class="container d-flex  me-lg-3">
    <div class="col-lg-8 col-md-12 me-lg-5">
        ...
        <%
        com.user.Admin ad = (com.user.Admin) session.getAttribute("adminS");
        ...
        <div class="container mt-2 pt-lg-4 overflow-y-scroll" id="showblog" style="height:100vh;">
            <% 
                java.util.List<Post> post = com.DAO.AdminDAO.showBlogs();
                for(Post po : post) { 
                 %>
                <a href="AdminIndividual.jsp?id=<%= po.getId() %>" class="row text-decoration-none">
